...
export interface AuditEventInput {
  ...
  /** The `Transcript.id` this summary run is for. Not unique across attempts — dedup hits and
...
/**
 * Single write path for the meeting-summary audit trail (STORY-008), mirroring
 * `segmentMarking/auditLog.ts` and `diarization/auditLog.ts`. Every call gets its own fresh
